...
const SITEMAP = [
  ...
  },
  {
    ...
    links: ['Điều Khoảng chung', 'Câu hỏi thường gặp', 'Điều khoản giao dịch'],
  },
];

const currentYear = new Date().getFullYear();
interface PropsHeader {}
const Footer: React.FC<PropsHeader> = () => {
  return (
    <footer className="relative w-full bg-main-background">
      <div className="mx-auto w-full px-8 xl:w-1170">
        <div className="mx-auto grid w-full grid-cols-1 gap-8 py-12 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col gap-5 pr-32">
            <img src="https://metiz.vn/static//assets/websites/images/logo_footer.png" />
